...
export default function EmailChanged({ verifyUrl = "https://app.buildrik.app/auth/verify-email?token=xxx" }: EmailChangedProps) {
  return (
    <Html>
      <Head />
      <Body style={{ fontFamily: "system-ui, sans-serif", backgroundColor: "#f8fafc" }}>
        <Container style={{ maxWidth: "600px", margin: "0 auto", backgroundColor: "white", borderRadius: "8px", padding: "40px" }}>
          ...
          <Text style={{ fontSize: "14px", color: "#64748B", textAlign: "center" as const }}>
            You requested an email address change on your Buildrik account. Click below to verify your new address.
          </Text>
          <Section style={{ textAlign: "center" as const, marginTop: "24px" }}>
            <Button href={verifyUrl} style={{ backgroundColor: "#6366F1", color: "white", padding: "12px 24px", borderRadius: "8px", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}>
              Verify
            </Button>
          </Section>
