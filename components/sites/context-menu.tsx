          ...
          {CONTEXT_MENU_ITEMS.map((item) => {
            ...
            return (
              <div key={item.action}>
                ...
                <button onClick={() => { onAction(item.action); setOpen(false); }} className="flex w-full items-center gap-2.5 px-3 py-1.5 text-sm transition-colors hover:bg-[#F4F4F4]" style={{ color: isDestructive ? "#E42313" : "#0D0D0D" }}>
