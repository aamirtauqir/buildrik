...
interface PageRowProps {
  ...
  /** Called on double-click to start rename */
  onRenameStart: () => void;
...
export const PageRow = React.memo<PageRowProps>(
  ({ page, isRenaming, isCtxOpen, onSelect, onRenameCommit, onRenameCancel, onContextMenu, onRenameStart, onSettingsClick, onOpenPage }) => {
