...
export const ColorPicker: React.FC<ColorPickerProps> = ({
  ...
  const handleSbUp = () => { isDraggingSb.current = false; };
  ...
  const handleHueUp = () => { isDraggingHue.current = false; };
  ...
  const handleAlphaUp = () => { isDraggingAlpha.current = false; };
  ...
  return (
    <div className="aqb-design-picker">
      ...
      <div className="aqb-design-picker__sb-wrap">
        ...
        />
        <div
          className="aqb-design-picker__crosshair"
      ...
      <div className="aqb-design-picker__slider-wrap">
        ...
        />
        <div
          className="aqb-design-picker__knob"
          style={{ left: hueX }}
          aria-hidden
        />
      </div>
      ...
      <div className="aqb-design-picker__hex-row">
        <div className="aqb-design-picker__swatch-preview" style={{ background: currentHex.slice(0, 7) }} />
        <div className={`aqb-design-picker__hex-input-wrap${hexError ? " aqb-design-picker__hex-input-wrap--error" : ""}`}>
        ...
        <span className="aqb-design-picker__contrast-badge" title={`Contrast ratio: ${contrastRatio.toFixed(1)}:1`}>
          {contrastRatio.toFixed(1)}:1
        </span>
      </div>

      {hexError && (
        <div className="aqb-design-picker__hex-error">Invalid hex color</div>
      )}
