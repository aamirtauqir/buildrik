...
const VIEWPORT_ICONS: Record<string, React.ReactElement> = {
  desktop: (
    <svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
               background: #fff; transform: scale(0.2); transform-origin: top left;
               width: ${currentViewport.frameWidth * 5}px; overflow: hidden; }
      </style>
    ...
    >
      ...
      <div className="tmpl-preview__bottom">
        ...
        <button className="tmpl-preview__use" onClick={() => onUseTemplate(template)}>
          {template.status === "premium" ? "Upgrade to Use →" : "Use This Template"}
        </button>
      </div>
    </div>
  );
