...
describe("Plan Limits", () => {
  ...
  it("all resource keys are present for each plan", () => {
    const requiredKeys = ["sites","pagesPerSite","customDomains","teamMembers","storageMB","bandwidthMB","aiGenerations","fileUploadMaxMB","formSubmissions","urlRedirects","integrations","analyticsRetentionDays","shareLinkExpiryMaxDays","shareLinkPasswords","priceMonthly","priceYearly"];
