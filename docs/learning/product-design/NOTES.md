...
- L8 (next): apply the loop+constitution to a real surface AS A COMPLETE PROTOTYPE (all states). Topbar is the obvious candidate — design its Saving/Offline/Publishing/Failed states, then build. OR move to the rail/inspector.
