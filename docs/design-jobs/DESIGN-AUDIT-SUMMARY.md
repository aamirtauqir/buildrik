...
| `D-F-38` | AI | Checked, no gap | ai.summarize has no editor caller (FormsScreen.tsx:405's summarize is a local function). ai.milestoneSuggest reaches HistoryTab vi |
