...
| Invited content editor (MEMBER) | `?view=client` → density `fewer` (`editorViewMode.ts:31-36`) | Edit copy/images on assigned sites without breaking layout |
