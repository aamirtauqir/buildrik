    ...
    <div ref={overlayRef} className="med-detail-overlay" role="dialog" aria-modal="true" aria-label={item.name}>
      ...
      {metaError ? (
        ...
        <div className="med-detail-error-body">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--buildrick-text-secondary, #94A3B8)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
