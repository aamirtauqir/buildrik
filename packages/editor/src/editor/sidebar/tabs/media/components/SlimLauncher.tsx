            ...
            searchQuery.trim() ? (
              <div className="tw:px-4 tw:pt-8 tw:text-left tw:text-[13px] tw:leading-5" data-testid="media-no-results" role="status">
                ...
                <Button
                  ...
                  color="light"
                  size="xs"
                  className="tw:mt-1.5 tw:min-h-6 tw:border-0 tw:bg-transparent tw:px-0 tw:text-[13px] tw:font-normal tw:text-[var(--bk-accent-text)] tw:enabled:hover:bg-transparent tw:enabled:hover:underline"
      ...
      <div className="sl-upload-footer" data-testid="media-footer-region" hidden={props.selectionMode}>
        ...
        >
          <Button
            ...
            color="light"
            size="xs"
            className="tw:min-h-6 tw:gap-1.5 tw:border-0 tw:bg-transparent tw:px-0 tw:text-[13px] tw:font-normal tw:text-[var(--bk-accent-text)] tw:enabled:hover:bg-transparent tw:enabled:hover:underline"
