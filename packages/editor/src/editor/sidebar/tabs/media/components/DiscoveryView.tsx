...
// Gate: flip to true when Unsplash/Pexels API key is configured
const STOCK_API_CONFIGURED = false;
import type {
  DiscFont,
  DiscIcon,
  DiscoveryViewProps,
...
export function DiscoveryView({
  ...
  if (!STOCK_API_CONFIGURED && (activeType === "img" || activeType === "vid" || showAll)) {
    return (
      <div
        style={{
          padding: "24px 16px",
      ...
      >
        ...
        <div>Add your Unsplash or Pexels API key in Settings to browse stock photos.</div>
      </div>
    );
  }
