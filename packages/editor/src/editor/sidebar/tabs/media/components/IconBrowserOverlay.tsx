...
export function IconBrowserOverlay({ onClose, onPick }: IconBrowserOverlayProps) {
  ...
  return (
    ...
    >
      ...
      <Button
        className="tw:flex tw:h-9 tw:w-full tw:items-center tw:justify-start tw:border-0 tw:bg-transparent tw:px-4 tw:text-left tw:text-[13px] tw:leading-5 tw:text-blue-700 tw:enabled:hover:bg-transparent tw:enabled:hover:underline"
        onClick={onClose}
