...
export interface TemplateItem {
  ...
  status?: "free" | "premium";
  category?: string;
  /** Industry vertical tag — for analytics + secondary filters. Not part of top-level IA. */
