    ...
    <div className={`bd-ai-msg bd-ai-msg-${role}`}>
      ...
      <div className={`bd-ai-msg-body${streaming ? " bd-ai-msg-streaming" : ""}`}>
        {/* Board 170:29 — before any text arrives the panel says "Thinking…"
            ...
            role label above it. */}
        {streaming && !text ? <p data-testid="ai-thinking" className="tw:m-0 tw:flex tw:h-14 tw:items-center tw:bg-[var(--bk-accent-tint)] tw:px-4 tw:text-[12px] tw:leading-[18px] tw:text-[var(--bk-accent-text)]">Thinking…</p> : null}
        {text ? <p>{text}</p> : null}
