  ...
  <>
    ...
    {hasParent && (
      <Tooltip content="Select Parent · ←" placement="bottom" arrow={false} className="tw:max-w-[280px] tw:whitespace-normal">
        <Button color="light" onClick={onSelectParent} style={parentBtnStyles} aria-label="Select parent element" className="tw:px-0 tw:border-transparent tw:bg-transparent tw:text-[var(--bk-ink-soft)] tw:hover:text-[var(--bk-ink)]">
          <svg
            width="12"
            height="12"
            viewBox="0 0 24 24"
