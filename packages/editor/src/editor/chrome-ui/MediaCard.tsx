...
export function MediaCard({ name, src, badge, badgeKind = "neutral", className, ...rest }: MediaCardProps) {
  return (
    ...
    >
      ...
      <span className="tw:relative tw:aspect-[4/3] tw:rounded-md tw:border tw:border-[var(--bk-gray-200)] tw:bg-[var(--bk-gray-100)] tw:overflow-hidden tw:outline-none tw:group-focus-visible:[box-shadow:var(--bk-shadow-focus)]">
