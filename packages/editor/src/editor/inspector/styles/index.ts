...
export const panelStyles = {
  ...
  // Underline tab per new-design spec: transparent bg, 2px cobalt border
  // on active, bottom-aligned. Flat, no pill.
  tab: (active: boolean) => ({
    flex: 1,
    padding: "7px 4px",
    background: "transparent",
    border: "none",
    borderBottom: `2px solid ${active ? "var(--buildrick-accent)" : "transparent"}`,
    borderRadius: 0,
    color: active
