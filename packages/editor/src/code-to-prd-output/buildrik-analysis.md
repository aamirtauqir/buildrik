# Codebase Analysis: buildrik

**Framework:** react
**Stack type:** frontend
**Total files:** 1274
**API calls detected:** 0 (0 integrated, 0 mock)
**Enums:** 10
**i18n:** No
**State management:** No
...
### mapEmbedBlockConfig (constant_map)
| Key | Value |
|-----|-------|
| id | map-embed |
| label | Map Embed |
