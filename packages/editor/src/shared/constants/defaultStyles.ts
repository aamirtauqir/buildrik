...
export const DEFAULT_ELEMENT_STYLES: Record<string, Record<string, string>> = {
  ...
  button: {
    "font-family": THEME.fontFamily,
    "font-size": "var(--buildrick-design-btn-font-size)",
    "font-weight": "var(--buildrick-design-btn-font-weight)",
  ...
  input: {
    "font-family": THEME.fontFamily,
    "font-size": "var(--buildrick-design-label-font-size)",
    height: "var(--buildrick-design-input-height)",
    "padding-left": "var(--buildrick-design-input-padding-x)",
