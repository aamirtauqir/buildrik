      ...
      {confirmDelete && (
        <div
          style={{
            ...
            padding: "12px 20px",
            background: /* @lint-hex-policy: template preview/thumbnail color — not editor chrome */ "#ef4444",
            color: /* @lint-hex-policy: template preview/thumbnail color — not editor chrome */ "#fff",
            borderRadius: 8,
            fontSize: 13,
            zIndex: 1000,
          }}
