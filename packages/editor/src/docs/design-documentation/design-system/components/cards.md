...
- **Border radius:** `--aqb-radius-lg` (8px)
- **Padding:** `--aqb-space-4` (16px)
- **Content:** Icon (24px, `--aqb-text-secondary`) + label (`--aqb-heading-sm`)
...
- **Thumbnail:** Square aspect ratio, `--aqb-radius-md` corners
...
- **Selected:** 2px `--aqb-primary` border

## Element Tile (Add Tab)
- **Size:** ~64px × 64px (grid layout)
- **Background:** `--aqb-chrome-surface`
- **Border:** 1px `--aqb-chrome-border`
- **Border radius:** `--aqb-radius-md`
...
- **Star (Favorite):** Small star icon top-right corner, `--aqb-warning` when active
