...
- TemplateManager is gone (2026-09-24, G2-103): templates land on the `importHTMLToActivePage` path; the catalogue and saved templates live in `editor/sidebar/tabs/templates/`.
