...
/**
 * Inlined from editor/design-system/constants.ts DEFAULT_TOKENS (D3e
 * 2026-05-22). Migration shouldn't reach into editor/ for seed data —
 * keeping engine self-contained per CLAUDE.md import-direction rule.
