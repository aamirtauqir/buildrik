    ...
    <div>
      ...
      {articleQuery.isLoading ? (
        <div className="space-y-3">
          <div className="h-8 w-2/3 animate-pulse rounded" style={{ backgroundColor: "#F4F4F4" }} />
          <div className="h-4 w-1/4 animate-pulse rounded" style={{ backgroundColor: "#F4F4F4" }} />
          <div className="mt-6 space-y-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-4 animate-pulse rounded" style={{ backgroundColor: "#F4F4F4" }} />
            ))}
          </div>
        </div>
      ) : articleQuery.error ? (
        ...
        <div>
          ...
          {/* Was this helpful? */}
          <div className="mt-10 rounded-xl border p-6 text-center" style={{ borderColor: "#E8E8E8" }}>
            {feedbackGiven ? (
              ...
              <>
                <p className="mb-4 text-sm font-medium" style={{ color: "#0D0D0D" }}>
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <button
                    ...
                    disabled={feedbackMutation.isPending}
                    className="flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition-colors hover:border-red-300 hover:bg-red-50"
                    style={{ borderColor: "#E8E8E8", color: "#0D0D0D" }}
                  >
